...
>>>>>>> b86ce3b (fix 0.6)
      ...
      FDecl(0x908810, SetObject, __thiscall void (*)(LuaObject* this_, const LuaObject&, LuaObject&))
      FDecl(0x908760, SetObject2, __thiscall void (*)(LuaObject* this_, const char*, LuaObject&))
      FDecl(0x9087a0, SetObject3, __thiscall void (*)(LuaObject* this_, int, LuaObject&))
